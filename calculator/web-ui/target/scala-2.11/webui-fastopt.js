...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  var str = $as_T(tweetText.apply__O());
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(str$1) {
    return (function() {
      return ((140 - $m_Lcalculator_TweetLength$().calculator$TweetLength$$tweetLength__T__I(str$1)) | 0)
    })
  })(str));
